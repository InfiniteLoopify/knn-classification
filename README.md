<!-- TODO: REPLACE ALL `knn-classification`, `KNN Classifier`, `K Nearest Neighbor Classification using tf-idf and cosine similarity`. FILL "about the project" and uncomment hidden sections if needed -->
<a name="readme-top"></a>
...
<br />
<div align="center">
  <!-- <a href="https://github.com/InfiniteLoopify/knn-classification">
    <img src="images/logo.png" alt="Logo" width="80" height="80">
  </a> -->
<h3 align="center">KNN Classifier</h3>

  <p align="center">
    K Nearest Neighbor Classification using tf-idf and cosine similarity
    <br />
    <a href="https://github.com/InfiniteLoopify/knn-classification"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <!-- <a href="https://github.com/InfiniteLoopify/knn-classification">View Demo</a>
    · -->
    <a href="https://github.com/InfiniteLoopify/knn-classification/issues/new?labels=bug&template=bug-report---.md">Report Bug</a>
    ·
    <a href="https://github.com/InfiniteLoopify/knn-classification/issues/new?labels=enhancement&template=feature-request---.md">Request Feature</a>
  </p>
</div>
...
K Nearest Neighbor Classification for documents using tf-idf and cosine similarity on Vector Space Model. Use BBC Sports data to classify into 5 classes (athletics, cricket, football, rugby and tennis).

![Screenshot](images/screenshot.png)
*predict correct classes with an accuracy of 98.65%*
...
2. Clone the repository:
    ```bash
    git clone https://github.com/InfiniteLoopify/knn-classification.git
    ```
...
See the [open issues](https://github.com/InfiniteLoopify/knn-classification/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/InfiniteLoopify/knn-classification](https://github.com/InfiniteLoopify/knn-classification)
...
[contributors-shield]: https://img.shields.io/github/contributors/InfiniteLoopify/knn-classification.svg?style=for-the-badge
[contributors-url]: https://github.com/InfiniteLoopify/knn-classification/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/InfiniteLoopify/knn-classification.svg?style=for-the-badge
[forks-url]: https://github.com/InfiniteLoopify/knn-classification/network/members
[stars-shield]: https://img.shields.io/github/stars/InfiniteLoopify/knn-classification.svg?style=for-the-badge
[stars-url]: https://github.com/InfiniteLoopify/knn-classification/stargazers
[issues-shield]: https://img.shields.io/github/issues/InfiniteLoopify/knn-classification.svg?style=for-the-badge
[issues-url]: https://github.com/InfiniteLoopify/knn-classification/issues
[license-shield]: https://img.shields.io/github/license/InfiniteLoopify/knn-classification.svg?style=for-the-badge
[license-url]: https://github.com/InfiniteLoopify/knn-classification/blob/master/LICENSE
