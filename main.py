...
class Table:
    ...
    def create_Gui(self, indexer):
        ...
        self.label = tk.Label(self.scores, text="KNN", font=(
        ...
        self.label = tk.Label(self.scores, text="KNN Value:\t"+"3",
                              font=("Arial", 10)).place(x=694+160, y=48-40)
        self.label = tk.Label(self.scores, text="Training Data:\t" + str(int(indexer.param[0]*100))+"%",
                              font=("Arial", 10)).place(x=694+160, y=48-20)
        self.label = tk.Label(self.scores, text="Testing Data:\t" + str(int(100-indexer.param[0]*100))+"%",
                              font=("Arial", 10)).place(x=694+160, y=48-0)
        ...
        self.display_Table(indexer.result, indexer.param,
                           indexer.test_label, indexer.test_label_id, indexer.classes_names)
